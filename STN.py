...
class STN(object):
    ...
    def build(self, TIME):
        ...
        m.StorageCost = Var(domain=NonNegativeReals)
        ...
        m.Obj = Objective(expr=m.Value - m.Cost - m.StorageCost, sense=maximize)
    ...
    def solve(self, solver="glpk"):
        self.solver = SolverFactory(solver, solver_io="lp")
